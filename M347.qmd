...
::: {layout="[[1,1,1]]"}
![](extract.png){.lightbox width="60%" height="60%" fig-align="center"}

![](coursebooks.png){width="60%" height="60%"}

![](extraexercises.png){width="60%" height="60%"}
:::
...
{{< video animate2.mp4 width="100%" height="100%">}}
...
So if the correlation $\rho = 0$, this simplifies to:
$$f(z,w) = \frac{1}{2\pi} \exp \left[-\frac{1}{2} \left({z^2 + w^2}\right)\right] $$
...
![](glmquestion.png){.lightbox width="60%" height="60%" fig-align="center"}
---

![](glmanswer.png){.lightbox width="60%" height="60%" fig-align="center"}
...
![© Sidney Harris / ScienceCartoonsPlus.com](harris.png)
